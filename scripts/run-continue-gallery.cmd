...
echo [%date% %time%] continue gallery: empty pass relaxed >> data\gallery-round2-log.txt
set MIN_SCORE_OPENI=16
set MIN_SCORE_WIKI=10
set MIN_SCORE_RAD=12
node scripts\supplement-batch2-multi-source.mjs --all --max 20 --empty-only --round2 >> data\gallery-round2-log.txt 2>&1

echo [%date% %time%] continue gallery: round2 strict under-20 >> data\gallery-round2-log.txt
...
echo [%date% %time%] continue gallery done >> data\gallery-round2-log.txt
